...
const demoData = {
    ...
    quickActions: [
        { label: 'Plan Production', icon: 'fa-calendar-plus', path: '../Plan/plan.html' },
        { label: 'Manage Surplus', icon: 'fa-box-open', path: '../Surplus/surplus.html' },
        { label: 'Route Optimization', icon: 'fa-route', path: '../Network/network.html' },
        { label: 'Efficiency Monitoring', icon: 'fa-tachometer-alt', path: '../Efficiency/efficiency.html' },
        { label: 'Impact & Analytics', icon: 'fa-chart-line', path: '../Impact/impact.html' }
    ],
    ...
    surplus: {
        ...
        managePath: '../Surplus/surplus.html'
    },
    ...
    route: {
        ...
        viewRoutePath: '../Network/network.html'
    },
    ...
    efficiency: {
        ...
        viewEfficiencyPath: '../Efficiency/efficiency.html'
    },
    ...
    impact: {
        ...
        viewAnalyticsPath: '../Impact/impact.html'
    }
};
...
function renderHeaderIdentity() {
    ...
    // Keep the kitchen/profile dropdown header in sync too.
...
// ============================================================
// TASK 1 + SYNC — KITCHEN / PROFILE DROPDOWN
...
// trigger that opened it, so positioning follows the trigger.
// On close, it returns to the top-right wrapper.
//
// There is exactly ONE outside-click handler and ONE Escape handler
// for this dropdown, both registered on document.
// ============================================================
(function initKitchenDropdown() {
    ...
    function placeIn(wrapper, trigger) {
        // Move the single dropdown node into the given wrapper.
        ...
        // aria-expanded on every trigger — only the active one is true.
    ...
    function close() {
        ...
        // Return the dropdown to its default home so the DOM stays tidy.
    ...
    // Two button listeners, one shared handler. This is NOT a duplicate
    // handler — it is two triggers pointing at the same function.
    ...
    // ONE outside-click handler for the dropdown.
    ...
    // ONE Escape handler for the dropdown.
